...
/import/monstrum/ONM/scripts/structural/freesurfer/qa/cnr_flag.sh $slist $SUBJECTS_DIR
...
/import/monstrum2/Applications/R3.2.3/bin/R --slave --file=/import/monstrum/ONM/scripts/structural/freesurfer/qa/flag_outliers.R --args $SUBJECTS_DIR
