#this script will run probtrackx on the bedpostx data in ONM

#for each ONM subject with processed bedpostx
for i in `ls -d /import/monstrum/ONM/subjects/*/*_DTI_*/bedpostx.bedpostX`; do

#create variables for the subject id and dti directory
...
#for each seed mask in that folder
